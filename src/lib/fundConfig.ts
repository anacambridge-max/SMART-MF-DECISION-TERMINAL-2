export type FundConfig = {
  ...
  underlyingNseSymbol?: string;
  underlyingBseCode?: string;
};
...
export const DEFAULT_FUNDS: FundConfig[] = [
  ...
  // UTI Gold ETF FoF: score against the Gold benchmark, but source the live quote from the actual underlying UTI Gold ETF.
  // UTI Gold ETF: NSE GOLDBETA, BSE code 590101, AMFI scheme code 105463.
  { id: 14, name: "UTI Gold ETF FoF Direct Growth", amfiCode: "150714", proxyIndex: "GOLD", category: "Commodity - Gold", primarySector: "Gold", primaryProxy: "GOLD", secondaryProxies: [], underlyingAmfiCode: "105463", underlyingSchemeName: "UTI Mutual Fund - UTI Gold Exchange Traded Fund", underlyingNseSymbol: "GOLDBETA", underlyingBseCode: "590101" },
